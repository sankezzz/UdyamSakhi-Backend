        ...
        if "messages" in value:
            ...
            if "interactive" in message:
                ...
                if button_id == "menu_button":
                    send_menu_with_images(sender)  # ✅ Updated to send image first
...
def send_menu_with_images(to):
    """Send menu image first, then interactive menu"""
    
    # Step 1: Send Image Message
    image_url = "https://your-server.com/images/menu.jpg"  # Replace with actual image URL
    send_image(to, image_url, "🍕 Here's our delicious menu!")

    # Step 2: Send Interactive List Menu
    send_menu(to)
